...
# ── Web dashboard (exwarmer) ──────────────────────────────
WEB_HOST     = os.getenv("WEB_HOST", "0.0.0.0")
WEB_PORT     = int(os.getenv("WEB_PORT", "8080"))
WEB_PASSWORD = os.getenv("WEB_PASSWORD", "exwarmer")
...
PEER_DM_OPENERS = [
    ...
    "Эй, ты тут? 🙂",
    "Здарова, что делаешь?",
    "Привет, давно не писали!",
    "Как настроение?",
    "Йо, как жизнь?",
    "Привет! Как выходные?",
    "Ну чё, как ты?",
    "Давно не общались, привет!",
    "Слушай, есть минутка?",
]
...
PEER_CHAT_REPLIES = [
    ...
    "Да, тут 🙂 А ты?",
    "Ха, всё ок 👍",
    "Неплохо, работаю потихоньку",
    "Отлично! Только что отдыхал",
    "Да ничего, скучновато немного",
    "Норм, спасибо что написал!",
    "Ахах, да так себе 😄",
    "Всё супер, рад что написал",
    "Занят был, сорри что не сразу",
    "О, приятно! Как сам?",
    "Да, бывает. Что нового?",
    "Согласен с тобой 😄",
